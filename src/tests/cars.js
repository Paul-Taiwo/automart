...
const token = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8qxznggLuc32Pws5peWOPmOvZmgdaYgO0MqHb3QHbLI';
const adminToken = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..qgGM9YVHtssQhN0JWvIy0mPmyCk_rYCzzTH7QQllaxY';
...
describe('Test for car AD endpoint', () => {
  ...
  it('Should return all cars of a specific owner', (done) => {
    chai
      .request(app)
      .get('/api/v1/car')
      .query({
